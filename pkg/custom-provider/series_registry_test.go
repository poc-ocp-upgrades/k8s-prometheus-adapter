...
var seriesRegistryTestSeries = [][]prom.Series{{{Name: "container_some_time_seconds_total", Labels: pmodel.LabelSet{"pod_name": "somepod", "namespace": "somens", "container_name": "somecont"}}}, {{Name: "container_some_count_total", Labels: pmodel.LabelSet{"pod_name": "somepod", "namespace": "somens", "container_name": "somecont"}}}, {{Name: "container_some_usage", Labels: pmodel.LabelSet{"pod_name": "somepod", "namespace": "somens", "container_name": "somecont"}}}, {{Name: "node_gigawatts", Labels: pmodel.LabelSet{"kube_node": "somenode"}}, {Name: "service_proxy_packets", Labels: pmodel.LabelSet{"kube_service": "somesvc", "kube_namespace": "somens"}}}, {{Name: "ingress_hits_total", Labels: pmodel.LabelSet{"kube_ingress": "someingress", "kube_service": "somesvc", "kube_pod": "backend1", "kube_namespace": "somens"}}, {Name: "ingress_hits_total", Labels: pmodel.LabelSet{"kube_ingress": "someingress", "kube_service": "somesvc", "kube_pod": "backend2", "kube_namespace": "somens"}}, {Name: "volume_claims_total", Labels: pmodel.LabelSet{"kube_persistentvolume": "somepv"}}}, {{Name: "work_queue_wait_seconds_total", Labels: pmodel.LabelSet{"kube_deployment": "somedep", "kube_namespace": "somens"}}, {Name: "node_fan_seconds_total", Labels: pmodel.LabelSet{"kube_node": "somenode"}}}}
